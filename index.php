<?php
 ...
 $profileData = require_once ('./profile-data.php');
 $educations = getSortedArray($profileData['education']);
 // берет элементы массива education c ключем yearStart и делает из них свой собственный массив
 // предварительно отсортировав его
...
<div class="wrapper">
    <div class="sidebar-wrapper">
        ...
        <div class="contact-container container-block">
            <ul class="list-unstyled contact-list">
                ...
                <li class="linkedin"><i class="fa fa-linkedin"></i><a href="#" target="_blank"><?=$profileData['about']['linkedin']?></a></li>
                <li class="github"><i class="fa fa-github"></i><a href="#" target="_blank"><?=$profileData['about']['github']?></a></li>
                <li class="twitter"><i class="fa fa-twitter"></i><a href="https://<?=$profileData['about']['twitter']?>" target="_blank"><?=$profileData['about']['twitter']?></a></li>
            </ul>
        ...
        <div class="languages-container container-block">
            ...
            <ul class="list-unstyled interests-list">
                <? foreach($profileData['languages'] as $languages){ ?>
        ...
        <div class="interests-container container-block">
            ...
            <ul class="list-unstyled interests-list">
                <? foreach($profileData['interests'] as $interests){ ?>
                <li><?=$interests?></li>
                <? } ?>
            </ul>
        </div><!--//interests-->
    ...
    <div class="main-wrapper">
        ...
        <section class="section projects-section">
            ...
            <? foreach ($careerData['projects'] as $projects) { ?>
            <div class="item">
                <span class="project-title"><a href="#hook"><?=$projects['title'] ?></a></span> - <span class="project-tagline"><?= $projects['about'] ?></span>
